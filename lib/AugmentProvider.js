...
var AnalyticsContextAugmentProvider = function (_React$Component) {
    ...
    _createClass(AnalyticsContextAugmentProvider, [{
        ...
        value: function render() {
            ...
            var test = React.createElement(Provider_1.Provider, { analyticsContext: augmentContext_1.augmentAnalyticsContext(this.props.analyticsContext, this.props.augmentContext) }, this.props.children);
