...
let AnalyticsContextAugmentProvider = class AnalyticsContextAugmentProvider extends React.Component {
    render() {
        ...
        const test = React.createElement(Provider_1.Provider, { analyticsContext: augmentContext_1.augmentAnalyticsContext(this.props.analyticsContext, this.props.augmentContext) }, this.props.children);
